...
" add for js Math
syntax keyword javaScriptGlobalObjects  E LN2 LN10 LOG2E LOG10E PI SQRT1_2 SQRT abs acos asin atan atan2 ceil cos exp floor log max min pow random round sin sqrt tan toSource valueOf
" add for js String
syntax keyword javaScriptGlobalObjects  anchor big blink bold charAt charCodeAt concat fixed fontcolor fontsize fromCharCode indexOf italics lastIndexOf link localeCompare match replace search slice small split strike sub substr substring sup toLocaleLowerCase toLocaleUpperCase toLowerCase toUpperCase toString
" add for js Array
syntax keyword javaScriptGlobalObjects constructor join pop push reverse shift sort splice toLocaleString unshift
" add for js Date
syntax keyword javaScriptGlobalObjects Date getDate getDay getMonth getFullYear getYear getHours getMinutes getSeconds getMilliseconds getTime getTimezoneOffset getUTCDate getUTCDay getUTCMonth getUTCFullYear getUTCHours getUTCMinutes getUTCSeconds getUTCMilliseconds parse setDate setMonth setFullYear setYear setHours setMinutes setSeconds setMilliseconds setTime setUTCDate setUTCMonth setUTCFullYear setUTCHours setUTCMinutes setUTCSeconds setUTCMilliseconds toTimeString toDateString toGMTString toUTCString toLocaleString toLocaleTimeString toLocaleDateString UTC
" add for js Number
syntax keyword javaScriptGlobalObjects MAX_VALUE MIN_VALUE NaN NEGATIVE_INFINITY POSITIVE_INFINITY toLocaleString toFixed toExponential toPrecision
" add for js RegExp
